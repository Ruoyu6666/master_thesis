...
from util import DataLoaderS, masked_mae, masked_mape, metric
...
parser.add_argument('--data', type=str, default='./data/others/electricity.txt', help='location of the data file')
parser.add_argument('--log_interval', type=int, default=2000, metavar='N', help='report interval')
parser.add_argument('--save', type=str, default='./model/model-mixhop.pt', help='path to save the final model')
...
def main():
    ...
    ### Save The Result ###
    #np.save(f"./predict/predictSolarH.npy", Ytest)
    #np.save(f"./predict/testSolarH.npy", predict)
