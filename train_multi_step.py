...
parser.add_argument('--adj_data', type=str,default='../data/sensor_graph/adj_mx_test.pkl',help='adj data path')
...
parser.add_argument('--buildH_true', type=str_to_bool, default=True, help='whether to construct adaptive adjacency matrix')
parser.add_argument('--num_hyperedge', type=int, default=8, help='number of hyperedges/variables')
...
parser.add_argument('--save',type=str,default='./save/model_test_mthgnn.pt',help='save path')
